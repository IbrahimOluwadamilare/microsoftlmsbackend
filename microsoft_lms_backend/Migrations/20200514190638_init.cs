        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedInSocial = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessContact_BusinessProfile_BusinessProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessExpertise", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusinessExpertise_BusinessProfile_BusinessProfileId",
                        column: x => x.BusinessProfileId,
                        principalTable: "BusinessProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(nullable: false),
                    DateUpdated = table.Column<DateTime>(nullable: false),
                    LearningTrackId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessContact_BusinessProfileId",
                table: "BusinessContact",
                column: "BusinessProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessExpertise_BusinessProfileId",
                table: "BusinessExpertise",
                column: "BusinessProfileId");
